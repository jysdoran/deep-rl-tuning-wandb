...
from ..provided import ReplayBuffer, DQN_CARTPOLE_CONSTANTS as CARTPOLE_CONSTANTS, \
    DQN_ACROBOT_CONSTANTS as ACROBOT_CONSTANTS
from .agent import DQN
from ..hparam_sweeping import generate_hparam_configs
from ..result_processing import Run, wandb_data_objects
...
CARTPOLE_CONFIG = {
    ...
    "eval_episodes": 100,
    # DECREASING THIS MIGHT REDUCE EVALUATION ACCURACY; BUT MAKES IT EASIER TO SEE HOW THE POLICY EVOLVES OVER TIME (BY ENABLING RENDER ABOVE)
